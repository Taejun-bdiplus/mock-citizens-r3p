...
@Component({
  selector: 'app-canned-report-dialog',
  templateUrl: './canned-report-dialog.component.html',
  styleUrls: ['./canned-report-dialog.component.css']
})
export class CannedReportDialogComponent {

  constructor(public dialogRef: MatDialogRef<CannedReportDialogComponent>) {}
